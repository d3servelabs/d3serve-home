...
const variants = cva(
  "inline-flex items-center justify-center rounded-full text-center leading-none tracking-widest transition-all duration-150 hover:scale-[101%] active:scale-[99%] disabled:cursor-not-allowed disabled:opacity-90 disabled:hover:scale-100 disabled:active:scale-100",
  {
    variants: {
      variant: {
        primary:
